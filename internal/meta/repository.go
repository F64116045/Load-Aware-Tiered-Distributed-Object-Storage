...
type Repository interface {
	...
	UpsertNodeHeartbeat(ctx context.Context, nodeID string, freeBytes int64, totalBytes int64, ioQueueDepth int, ioQueueBytes int64, cpuLoad float64, memoryUsedPct float64, diskIOWaitPct float64, status string) error
