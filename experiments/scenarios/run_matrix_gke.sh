...
export K8S_WORKLOAD_API_BASE="${K8S_WORKLOAD_API_BASE:-http://${K8S_API_SERVICE_NAME}:${K8S_API_SERVICE_PORT}}"
export K8S_WORKLOAD_IMAGE="${K8S_WORKLOAD_IMAGE:-alpine:3.18}"
